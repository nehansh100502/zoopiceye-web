...
//             className="bg-[#1684a0d7] text-white py-2 px-4 rounded-lg shadow-md hover:bg-[#15b8f9] transition duration-300 flex items-center justify-center h-10 w-full"
//           >
...
// const CartCard = ({ item }) => {
//   const { removeFromCart } = useAuth(); // Ensure removeFromCart is properly defined in context
//   const navigate = useNavigate();
