  ...
  return (
    <header className="header fixed top-5 left-0 right-0 z-50 bg-white shadow-md">
      ...
      <nav className="flex justify-between items-center h-20 px-4 md:px-6 relative">
        ...
        <Link
            to="/"
            className={`flex items-center gap-2 text-base transition-all duration-300 ${isActive('/') ? 'active-link'  : 'hover:text-[#189AB4]'}`}
          >
          ...
          <Link
            to="/SpectacleList"
            className={`flex items-center gap-2 text-base transition-all duration-300 ${isActive('/SpectacleList') ? 'active-link'  : 'hover:text-[#189AB4]'}`}
          >
          ...
          <Link
            to="/Blog"
            className={`flex items-center gap-2 text-base transition-all duration-300 ${isActive('/Blog') ? 'active-link'  : 'hover:text-[#189AB4]'}`}
          >
          ...
          <Link
            to="/Wishlist"
            className={`flex items-center gap-2 text-base transition-all duration-300 ${isActive('/Wishlist') ? 'active-link'  : 'hover:text-[#189AB4]'}`}
          >
          ...
          <Link
            to="/cart"
            className={`flex items-center gap-2 text-base transition-all duration-300 ${isActive('/cart') ? 'active-link' : 'hover:text-[#189AB4]'}`}
          >
