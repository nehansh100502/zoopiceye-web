...
const Login = () => {
  ...
  const [step, setStep] = useState(1); // Step state for OTP input
  const [showResetDropdown, setShowResetDropdown] = useState(false); // State to show/hide reset password form
